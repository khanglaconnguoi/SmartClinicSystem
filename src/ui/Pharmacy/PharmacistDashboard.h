...
private slots:
  ...
  void prevInvoicePage();
  void nextInvoicePage();
  ...
  void showCreateInvoiceDialog(const PrescriptionResultDTO &presc,
                               int patientId);
...
private:
  ...
  QPushButton *m_btnBillPrev = nullptr;
  QPushButton *m_btnBillNext = nullptr;
  QLabel *m_lblBillPageInfo = nullptr;
  int m_billCurrentPage = 1;
  int m_billPageSize = 10;
  int m_billTotalPages = 1;

  QLabel *m_lblBillPatientName = nullptr;
  QLabel *m_lblBillDetails = nullptr;
  QLabel *m_lblBillInsurancePercent =
      nullptr; // New UI label to show insurance coverage %
  ...
  // ────────────────────────────────────────────────────────────────
  // Sub-components: Leave Management
  // ────────────────────────────────────────────────────────────────
