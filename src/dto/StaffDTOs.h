...
// UI chịu trách nhiệm:
// - lấy thông tin trong form rồi dựa theo role để đóng thành DTO và gọi hàm phù
// hợp
...
struct StaffSearchCriteria {
  ...
  int pageSize =
      20; ///< Số bản ghi / trang. 0 = không phân trang (trả về tất cả)
 ...
 *        Khong chua thong tin ca nhan nhay cam (CCCD, email, dien thoai, dia
 * chi...) Duoc tao tu SystemUser::toPublicProfile() — khong can query DB them
 */
