...
public:
  ...
  QList<AppointmentRecord> getDoctorAppointments(const QString &doctorId,
                                                 const QString &date = "");
  ...
  bool createAppointment(int patientId, const QString &doctorCode, int createdBy,
                         const QString &date, const QString &startTime,
